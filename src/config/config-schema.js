...
export const CURRENT_CONFIG_SCHEMA = Object.freeze({
  ...
  sections: Object.freeze(["schemaVersion", "connectors", "personas", "triggers", "eventTriggers", "router", "context", "voicevox", "bouyomi", "speechQueue", "micMonitor", "commentReader", "commentSources", "news", "topics"]),
