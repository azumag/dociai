...
export const CURRENT_CONFIG_SCHEMA = Object.freeze({
  ...
  sections: Object.freeze(["schemaVersion", "connectors", "personas", "triggers", "eventTriggers", "router", "context", "research", "voicevox", "bouyomi", "speechQueue", "micMonitor", "commentReader", "commentSources", "news", "topics", "automation", "twitch", "captions"]),
