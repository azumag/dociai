...
try {
  ...
  assert.deepEqual(checks.keys, ["ai", "bouyomi", "captions", "capture", "config", "events", "feeds", "localLlm", "newsArticles", "newsSearch", "obs", "overlayAssets", "platform", "secrets", "shortcuts", "speech", "streamEvents", "system", "topics", "translation", "twitch", "update", "wikipedia", "windows"]);
